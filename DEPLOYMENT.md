# @vue-pivottable/multi-value-renderer 배포 가이드
...
| 항목 | 상태 | 비고 |
|------|------|------|
| GitHub 레포 | ✅ 완료 | vue-pivottable/multi-value-renderer |
...
4. 배포 완료 확인:
   ```bash
   npm info @vue-pivottable/multi-value-renderer
   ```
...
1. [npmjs.com](https://www.npmjs.com) → **@vue-pivottable/multi-value-renderer** 패키지 페이지
...
- [ ] NPM에서 패키지 확인 (`npm info @vue-pivottable/multi-value-renderer`)

### OIDC 전환
- [ ] NPM → 패키지 Settings → Trusted Publishing 설정
- [ ] Repository: `vue-pivottable/multi-value-renderer`
- [ ] Workflow filename: `publish.yml`
